      ...
      <div className='container'>
        ...
        <div className='about-content grid'>
          ...
          <div className='about-text'>
            ...
            <p className='fs-17'>We are passionate about books and believe that everyone should have access to the joy of reading. Thank you again for choosing our website, and happy readin.</p>
           </div>
        </div>
      </div>
    </section>
